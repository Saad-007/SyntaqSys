...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050505] text-white pt-16 md:pt-24 pb-8 md:pb-12 overflow-hidden font-sans relative">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 md:mb-24 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-24 w-full lg:w-auto">
             ...
             <div className="flex flex-col gap-4">
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Sitemap</h4>
             ...
             {/* SOCIALS */}
             <div className="flex flex-col gap-4">
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Socials</h4>
                {[
                  { 
                    name: 'LinkedIn', 
        ...
        <div className="border-t border-white/10 pt-12 pb-12">
           <motion.h1 
             ...
             viewport={{ once: true }}
             className="text-[15vw] md:text-[14vw] font-black leading-[0.8] tracking-tighter text-center lg:text-left text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-600 select-none cursor-default"
           >
             SYNTAQ
           </motion.h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-white/10">
           ...
           <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-center md:text-left">
              <span className="text-xs text-gray-500 font-mono">© {currentYear} SYNTAQ SYSTEMS</span>
